...
void setYear(long long& ts, int year) {
...
void setMonth(long long& ts, int month) {
    std::time_t seconds = ts / 1000;
    std::tm* tm = std::localtime(&seconds);
    tm->tm_mon = month - 1;
    tm->tm_sec = 0;
...
void setDay(long long& ts, int day) {
    std::time_t seconds = ts / 1000;
    std::tm* tm = std::localtime(&seconds);
    tm->tm_mday = day;
    tm->tm_sec = 0;
...
void setHour(long long& ts, int hour) {
    std::time_t seconds = ts / 1000;
    std::tm* tm = std::localtime(&seconds);
    tm->tm_hour = hour;
    tm->tm_sec = 0;
...
void setMinute(long long& ts, int minutes) {
    std::time_t seconds = ts / 1000;
    std::tm* tm = std::localtime(&seconds);
    tm->tm_min = minutes;
    tm->tm_sec = 0;
...
void setSecond(long long& ts, int segundo) {
    std::time_t seconds = ts / 1000;
    std::tm* tm = std::localtime(&seconds);
...
void setMillis(long long& ts, int millis)
{
    int actual = getMillis(ts);
    ts += (millis - actual);
}
