...
{
    //informar para cada estadio , cuantos partidos se jugaron
    //cuantos partidos se empataron
...
void punto1Mostrar(Coll<REquipo> cEq)
{
    ...
    int n = 0;
    collSort<REquipo>(cEq,cmpREquipo,rEquipoFromString,rEquipoToString);     // recorrer y mostrar
     while(n <= collSize<REquipo>(cEq)){
